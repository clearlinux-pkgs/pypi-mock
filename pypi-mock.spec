...
Source0  : https://files.pythonhosted.org/packages/07/8c/14c2ae915e5f9dca5a22edd68b35be94400719ccfa068a03e0fb63d0f6f6/mock-5.2.0.tar.gz
...
%prep
%setup -q -n mock-5.2.0
cd %{_builddir}/mock-5.2.0
pushd ..
cp -a mock-5.2.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1741023624
